...
@Component({
  selector: 'app-autre-classe',
  standalone: true,
  imports: [MaterialModule, CommonModule],
  templateUrl: './autre-classe.component.html',
  styleUrl: './autre-classe.component.scss'
})
export class AutreClasseComponent extends UnSubscrible implements OnInit {
...
getListEcole(): void {
    this.subs.sink = this.classeService.getAllClasse().subscribe({
        next: (data) => {
          let filterClasse = data.filter(x => x.niveau === 'Autre')
