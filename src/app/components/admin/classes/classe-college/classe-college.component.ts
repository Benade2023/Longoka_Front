...
@Component({
  selector: 'app-classe-college',
  standalone: true,
  imports: [MaterialModule, CommonModule],
  templateUrl: './classe-college.component.html',
  styleUrl: './classe-college.component.scss'
})
export class ClasseCollegeComponent extends UnSubscrible implements OnInit {
...
getListEcole(): void {
    this.subs.sink = this.classeService.getAllClasse().subscribe({
        next: (data) => {
          let filterClasse = data.filter(x => x.niveau === 'College')
