...
@Component({
  selector: 'app-classe-primaire',
  standalone: true,
  imports: [MaterialModule, CommonModule],
  templateUrl: './classe-primaire.component.html',
  styleUrl: './classe-primaire.component.scss'
})
export class ClassePrimaireComponent extends UnSubscrible implements OnInit {
...
getListEcole(): void {
    this.subs.sink = this.classeService.getAllClasse().subscribe({
        next: (data) => {
          let filterClasse = data.filter(x => x.niveau === 'Primaire')
